...
public class ControladorIndex extends ControladorBase {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String query = "SELECT p.id_producto as id, p.nombre_producto as nombre, p.id_categoria, MIN(i.img_path) AS imagen FROM productos p LEFT JOIN imagenes_productos i ON p.id_producto = i.id_producto WHERE listado = 1 GROUP BY p.id_producto, p.nombre_producto, p.id_categoria;";
